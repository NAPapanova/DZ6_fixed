...
class Author(models.Model):
    ...
    def update_rating(self):
        ...
        commentRat = self.authorUser.comment_set.all().aggregate(commentRat = Sum('rating'))
        cRat = 0
...
class Post(models.Model):
    ...
    def get_absolute_url(self): # добавим абсолютный путь. После создания поста сразу на с траницу с постом 
