...
def week_posts_notify(sender, instance, created, **kwargs):
...
post_save.connect(week_posts_notify, sender=Post)
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        scheduler.add_job(
            ...
            id="week_posts_notify",  # уникальный айди
            max_instances=1,
            replace_existing=True,
        )
        logger.info("Added job 'week_posts_notify'.")
